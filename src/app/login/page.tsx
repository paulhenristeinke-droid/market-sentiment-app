...
export default function LoginPage() {
  return (
    <div className="min-h-screen flex items-center justify-center bg-[var(--background)]">
      <div className="bg-[var(--card-bg)] border border-[var(--card-border)] rounded-lg p-8 max-w-sm w-full text-center">
        ...
        <p className="text-[10px] text-[var(--text-muted)] mt-4">
          Sign in to save your preferences and default asset.
        </p>
      </div>
    </div>
  );
